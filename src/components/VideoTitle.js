...
const VideoTitle = ({ title, overview, movieId }) => {
  ...
  return (
    <div className="w-screen aspect-video pt-[28%] md:pt-[18%] px-6 md:px-16 absolute bg-gradient-to-r from-black font-netflixSansRegular">
      <h1 className="text-lg md:text-6xl font-netflixSansBold text-white">
        {title}
      </h1>
